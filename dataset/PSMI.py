...
def _parse_example(example_proto):
    features = {
        ...
        "interface": tf.io.VarLenFeature(tf.int64)
    }
    ...
    target_seq = tf.sparse.to_dense(parsed_features['interface'],
                                            default_value=0)
...
def create_dataset_psmi(filenames, batch_size=16, max_length=128):
